        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="优秀教师" prop="jiaoshiTypes">
                        <el-select v-model="ruleForm.jiaoshiTypes" :disabled="ro.jiaoshiTypes" placeholder="请选择优秀教师">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="优秀教师" prop="jiaoshiValue">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jiaoshiTypes: [
                              { required: true, message: '优秀教师不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='jiaoshiTypes'){
                          this.ruleForm.jiaoshiTypes = obj[o];
                          this.ro.jiaoshiTypes = true;
                          continue;
                      }
                      if(o=='banjiTypes'){
