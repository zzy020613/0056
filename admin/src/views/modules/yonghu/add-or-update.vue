    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="chengguoName">
                       <el-input v-model="ruleForm.chengguoName"
                                 placeholder="标题" clearable  :readonly="ro.chengguoName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="标题" prop="chengguoName">
                           <el-input v-model="ruleForm.chengguoName"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yonghuPhoto" label="成果图片" prop="yonghuPhoto">
                        <file-upload
                            tip="点击上传成果图片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghuPhoto" label="成果图片" prop="yonghuPhoto">
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="yonghuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yonghuContent" label="详情" prop="yonghuContent">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuPhoto: [
                              { required: true, message: '成果图片不能为空', trigger: 'blur' },
                          ],
                   yonghuYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yonghuYesnoTypesOptions = data.data.list;
                    }
                });
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='chengguoName'){
                          this.ruleForm.chengguoName = obj[o];
                          this.ro.chengguoName = true;
                          continue;
                      }
                      if(o=='rongyuTypes'){
                      ...
                      if(o=='yonghuYesnoTypes'){
                          this.ruleForm.yonghuYesnoTypes = obj[o];
                          this.ro.yonghuYesnoTypes = true;
                          continue;
                      }
                      if(o=='yonghuPhone'){
                      ...
                      if(o=='yonghuContent'){
                          this.ruleForm.yonghuContent = obj[o];
                          this.ro.yonghuContent = true;
                          continue;
                      }
                      if(o=='yonghuDelete'){
