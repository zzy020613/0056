<template>
    <div class="main-content">
        <el-dialog title="审核" :visible.sync="yonghuYesnoTypesVisible">
            <el-form :model="form">
                <input type="hidden" v-model="form.id">
                <el-form-item label="审核" >
                    <el-select v-model="form.yonghuYesnoTypes" placeholder="请选择审核类型">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button @click="yonghuYesnoTypesVisible = false">取 消</el-button>
                <el-button type="primary" @click="yonghuYesnoTypesShenhe">提 交</el-button>
            </div>
        </el-dialog>
        <!-- 条件查询 -->
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.chengguoName" placeholder="标题" clearable></el-input>
                     </el-form-item>
         
                     <el-form-item :label="contents.inputTitle == 1 ? '类型' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.rongyuTypes" placeholder="类型" clearable></el-input>
                     </el-form-item>
                         
                     <el-form-item :label="contents.inputTitle == 1 ? '审核结果' : ''">
                        <el-select v-model="searchForm.yonghuYesnoTypes" placeholder="请选择审核结果">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in yonghuYesnoTypesSelectSearch"
                               v-bind:key="index"
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gaoxiaojiaoshichengguo/upload/yonghuMuBan.xls"
                        >批量导入学生成果数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yonghu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="yonghuYesnoTypes"
                                      header-align="center"
                                      label="审核结果">
                        <template slot-scope="scope">
                            {{scope.row.yonghuYesnoValue}}
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('yonghu','修改') && scope.row.yonghuYesnoTypes == 1 " type="primary" icon="el-icon-thumb" size="mini" @click="openYesnoTypes(scope.row.id)">审核</el-button>
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.chengguoName!= '' && this.searchForm.chengguoName!= undefined) {
                    params['chengguoName'] = '%' + this.searchForm.chengguoName + '%'
                }
                ...
                if (this.searchForm.yonghuYesnoTypes!= '' && this.searchForm.yonghuYesnoTypes!= undefined) {
                    params['yonghuYesnoTypes'] = this.searchForm.yonghuYesnoTypes
                }
                ...
                //填充下拉框选项
                this.$http({
                    url: "dictionary/page?dicCode=yonghu_yesno_types&page=1&limit=100",
                    method: "get",
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.yonghuYesnoTypesSelectSearch = data.data.list;
                    }
                });
            },
            //每页数
            ...
            openYesnoTypes(id) {
                let _this = this;
                _this.form.id = id;
                _this.form.yonghuYesnoTypes = "请选择审核结果";
                _this.yonghuYesnoTypesVisible = true;
            },

            yonghuYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.yonghuYesnoTypes == "请选择审核结果"){
                    alert("请选择审核结果");
                    return false;
                }
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        this.$message({
                            ...
                            duration: 1500,
                            onClose: () => {
                                _this.yonghuYesnoTypesVisible = false;
                                _this.search();
                            }
                        });
                    } else {
